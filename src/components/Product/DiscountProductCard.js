    ...
    if (!productExistInCart) {
      setCartState([
        ...cartState,
        {
          ...
          price: parseInt(currentProduct.price - currentProduct.discountPrice),
  ...
  return (
    <>
      {data && (
        ...
        >
          <div className="absolute top-2 left-2 bg-secondary w-9 h-9 rounded-full z-[100] text-bgColor text-[0.7rem] flex justify-center items-center">
